...
const BlogCard = ({
  ...
  return (
    <div className="border-b border-slate-200 p-2">
         <p> <Avatar author={author}/> {author} <span className="font-extralight pl-2">. {date}</span></p>
        <h1 className="font-semibold text-2xl">{title}</h1>
        <p className="font-thin text-xl">{description.length>100 ? description.slice(0,100)+"...":description}</p>
